...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'Game Devlog'),
    ...
    */
    ...
    'authors' => [
        'mr_hyde' => Author::create(
            ...
            name: 'Sagiys', // Optional display name
            website: 'https://game.sagiys.pl', // Optional website URL
    ...
    */
    ...
    'footer' => 'Zbudowano przy pomocy [HydePHP](https://github.com/hydephp/hyde) 🎩',
    ...
    */
    ...
    'server' => [
        ...
        'dashboard' => [
            ...
            // Should the dashboard be embedded on the default welcome page?
